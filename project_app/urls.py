...
urlpatterns = [
    ...
    path("user_document_verification/", views.user_document_verification, name = "user_document_verification_page"),
    path("user_document_verification_result/", views.user_document_verification_result, name = "user_document_verification_result_page"),
